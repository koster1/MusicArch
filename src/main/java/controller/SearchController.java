...
public class SearchController {
	...
	protected void initialize() {
		...
		/*try {
			...
			Label label = new Label("Eikö löytynyt, paina tästä!");
			SearchGrid.add(label, 0, 3);
			SearchGrid.add(button, 0, 3);
		} catch (Exception e) {
			System.out.println("Virhe latauksessa");
		}*/
...
//		sendR.setPadding(new Insets(5));
		...
		SearchGrid.add(form, 0 ,4);
				...
				sendR.addEventHandler(MouseEvent.MOUSE_CLICKED, new EventHandler<MouseEvent>() {
					...
					Label c = new Label("MOI");
					SearchGrid.add(c, 5, 4);
